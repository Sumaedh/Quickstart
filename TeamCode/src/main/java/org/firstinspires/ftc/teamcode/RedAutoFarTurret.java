...
@Autonomous
public class RedAutoFarTurret extends OpMode {
    ...
    private final Pose pickupLowIntake1 = new Pose(106.378, 36, Math.toRadians(0));
    private final Pose pickupLowIntake2 = new Pose(111.708, 36, Math.toRadians(0));
    ...
    private final Pose pickupMidIntake1 = new Pose(107, 60, Math.toRadians(0));
    private final Pose pickupMidIntake2 = new Pose(112, 60, Math.toRadians(0));
