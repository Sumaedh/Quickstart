...
public class SixBallLeaveFarRed extends OpMode {
    ...
    private final Pose secondPose = new Pose(55.6108, 19.8324, Math.toRadians(90)).mirror();
    private final Pose scorePose = new Pose(59.535, 16.93, Math.toRadians(137)).mirror();
    private final Pose pickup3Pose = new Pose(43.681, 35.484, Math.toRadians(180)).mirror();
    private final Pose pickup3PoseIntake1 = new Pose(37.622, 35.484, Math.toRadians(180)).mirror();
    private final Pose pickup3PoseIntake2 = new Pose(32.292, 35.484, Math.toRadians(180)).mirror();
    private final Pose pickup3PoseIntake3 = new Pose(27.17, 35.484, Math.toRadians(180)).mirror();
