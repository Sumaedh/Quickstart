...
@Autonomous
public class NineBallSafeCloseRed extends OpMode {
    ...
    private final Pose startPose = new Pose(20.389, 122.422, Math.toRadians(143)).mirror();

    private final Pose secondPose = new Pose(33.232, 109.751, Math.toRadians(127)).mirror();
    private final Pose scorePose = new Pose(55, 88, Math.toRadians(132)).mirror();
    //137
    private final Pose pickupLowPose = new Pose(48, 84, Math.toRadians(180)).mirror();
    private final Pose pickupLowIntake1 = new Pose(37.622, 36, Math.toRadians(180)).mirror();
    private final Pose pickupLowIntake2 = new Pose(32.292, 36, Math.toRadians(180)).mirror();
    private final Pose pickupLowIntake3 = new Pose(13, 84, Math.toRadians(180)).mirror();

    private final Pose pickupMidPose = new Pose(48, 60, Math.toRadians(180)).mirror();
    private final Pose pickupMidIntake1 = new Pose(37.622, 36 + 24, Math.toRadians(180)).mirror();
    private final Pose pickupMidIntake2 = new Pose(32.292, 36 + 24, Math.toRadians(180)).mirror();
    private final Pose pickupMidIntake3 = new Pose(13, 60, Math.toRadians(180)).mirror();

    private final Pose endPose = new Pose(48.06486486486487, 48.06486486486487, Math.toRadians(112)).mirror();
