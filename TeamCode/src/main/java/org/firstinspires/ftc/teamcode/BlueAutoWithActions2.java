...
public class BlueAutoWithActions2 extends OpMode {
    ...
    private final Pose pickup3Pose = new Pose(42.124, 29.584, Math.toRadians(180));
    private final Pose pickup3PoseIntake1 = new Pose(35.622, 29.584, Math.toRadians(180));
    private final Pose pickup3PoseIntake2 = new Pose(30.292, 29.584, Math.toRadians(180));
    private final Pose pickup3PoseIntake3 = new Pose(25.470, 29.584, Math.toRadians(180));
        ...
        switch (pathState) {
            ...
            case 7:
                ...
                if (!follower.isBusy()) {
                    ...
                    if (fsm.isFinished() || actionTimer.getElapsedTimeSeconds() > 4.0) {
                        shootingSequenceStarted = false;
