...
@Autonomous
public class BlueAutoFarMotif2 extends OpMode {
    ...
    public void buildPaths() {
        ...
        intakeLow = follower.pathBuilder()
                ...
                .addParametricCallback(0.54, () -> target = INCREMENT * 16) // Purple #2
        ...
        intakeMid = follower.pathBuilder()
                ...
                .addParametricCallback(0.32, () -> target = INCREMENT * 18) // Green
                .addParametricCallback(0.54, () -> target = INCREMENT * 16) // Purple
    ...
    public void autonomousPathUpdate() {
        ...
        switch (pathState) {
            ...
            case 7:
                target = INCREMENT * 18; // Green second
                if (Math.abs(sorterMotor.getCurrentPosition() - target) < sorterTolerance)
                    setPathState(8);
                break;
            ...
            case 10:
                target = INCREMENT * 16; // Purple third
