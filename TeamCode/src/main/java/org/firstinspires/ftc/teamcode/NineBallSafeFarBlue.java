...
@Autonomous
public class NineBallSafeFarBlue extends OpMode {
    ...
    private final Pose pickupMidPose = new Pose(42.265, 60.324, Math.toRadians(180));
    private final Pose pickupMidIntake3 = new Pose(25.189, 60.324, Math.toRadians(180));
    private final Pose endPose = new Pose(59.573, 43.514, Math.toRadians(90));
