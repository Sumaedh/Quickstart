...
public class BlueAutoREMODELEDParametric extends OpMode {
    ...
    private PathChain score1, alignToBalls, intakeBall1, intakeBall2, intakeBall3, score2, goToEnd, intakeAll3;
    ...
    public void buildPaths() {
        ...
        intakeAll3 = follower.pathBuilder()
                .addPath(new BezierLine(pickup3Pose, pickup3PoseIntake3))
                .addParametricCallback(0.3, sorter.setSorterTargetParametric(627.2))
                .addParametricCallback(0.61, sorter.setSorterTargetParametric(806.4))
                .setConstantHeadingInterpolation(pickup3PoseIntake3.getHeading())
                .setBrakingStrength(0.75)
                .build();
    }
    ...
    public void autonomousPathUpdate() {
        switch (pathState) {
            ...
            case 11:
                if (!follower.isBusy()) {
                    intake.intakeOn();
                    follower.followPath(intakeAll3, 0.3, true);
                    setPathState(12);
                }
                break;
